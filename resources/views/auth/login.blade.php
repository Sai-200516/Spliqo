    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-12">
        ...
        <div class="w-full max-w-sm">
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-8">
                <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1">Welcome back</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Sign in to your Spliqo account</p>

                @if (session('status'))
                    <div class="mb-4 px-4 py-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 text-sm border border-emerald-200 dark:border-emerald-800">
                        {{ session('status') }}
                    </div>
                @endif
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-xs text-emerald-600 dark:text-emerald-400 hover:underline">Forgot?</a>
                            @endif
                        </div>
            ...
            <p class="mt-5 text-center text-sm text-gray-500 dark:text-gray-400">
                ...
                <a href="{{ route('register') }}" class="text-emerald-600 dark:text-emerald-400 font-medium hover:underline">Create one</a>
            </p>
        </div>
    </div>
</x-guest-layout>
