            ...
            <form method="POST" action="{{ route('expenses.store') }}" enctype="multipart/form-data"
                ...
                <div x-data="{ recurring: false }">
                    <label class="flex items-center gap-2.5 cursor-pointer select-none">
                        <input type="checkbox" x-model="recurring" name="recurring" value="1"
                               class="w-4 h-4 rounded text-emerald-500 border-gray-300 dark:border-gray-600 focus:ring-emerald-500">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Make this a recurring expense</span>
                    </label>
                    <div x-show="recurring" x-cloak class="mt-3">
                        ...
                        <p class="mt-1.5 text-xs text-gray-400 dark:text-gray-500">A copy of this expense will be automatically added on schedule.</p>
                    </div>
                </div>
